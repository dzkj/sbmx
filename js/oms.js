(function (D) {
    ...
    extend(M.prototype, {
        defUI: function (mark) {
            ...
            if ($.mobile && !this.preferConfig) {
                ...
                inh = '<div id="doyoo_mon_innner" style="position:relative;width:100%;height:100%;-webkit-transform: translateZ(0px)">' +
                    ...
                    '<a id="doyoo_mon_accept" class="doyoo_mon_btn" href="javascript:;"' +
                    ' >' + (accs[lang] || 'CHAT') + '</a>' +
                ...
                try {
                    inh = '<div id="doyoo_mon_innner" style="position:relative;width:100%;height:100%;-webkit-transform: translateZ(0px)"><div id="doyoo_mon_head"></div><div id="doyoo_mon_main"></div>' +
                        '<div id="doyoo_mon_foot"><a id="doyoo_mon_accept" class="doyoo_mon_btn" href="javascript:;" ></a>' +
                        '<a id="doyoo_mon_phone" class="doyoo_mon_btn"  href="javascript:;" ></a>' +
                ...
                inh = '<div id="doyoo_mon_inner" style="position:relative;width:100%;height:100%;-webkit-transform: translateZ(0px)">'
                    ...
                    + '<a id="doyoo_mon_accept" href="javascript:;" style="position:absolute;margin-left:5px;display:block;left:{mbal}px;bottom:{mbab}px;width:{mbaw}px;height:{mbah}px;background:url({mbabg}) no-repeat;text-align:center"></a>'
                    + '<a id="doyoo_mon_phone" href="javascript:;"   style="position:absolute;display:block;margin:0;left:{mbpl}px;bottom:{mbpb}px;width:{mbpw}px;height:{mbph}px;background:url({mbpbg}) no-repeat;text-align:center"></a>'
                ...
                inh2 = '<div id="doyoo_mon_inner" style="position:relative;width:100%;height:100%;background-image:url({mbg});-webkit-transform: translateZ(0px)">'
                    + '<div id="doyoo_mon_head" class="doyoo_mon_head"  style="position:absolute;left:{mtl}px;top:{mtt}px;width:{mtw}px;height:{mth}px"  ></div>'
                    + '<a id="doyoo_mon_accept" href="javascript:;"  style="position:absolute;margin-left:5px;display:block;left:{mbal}px;bottom:{mbab}px;width:{mbaw}px;height:{mbah}px;background:url({mbabg}) no-repeat"></a>'
                    + '<a id="doyoo_mon_phone" href="javascript:;"   style="position:absolute;margin:0;display:block;left:{mbpl}px;bottom:{mbpb}px;width:{mbpw}px;height:{mbph}px;background:url({mbpbg}) no-repeat"></a>'
        ...
        force: (function () {
            ...
            var showEarlyMessage = function (msg, me) {
                ...
                if (!earlyPanel) {
                    ...
                    earlyPanel.innerHTML = '<div class="doyoo_early_wrap">' +
                        ...
                        '<a href="javascript:;" id="doyoo_early_closer">&nbsp;</a> </div>' +
            ...
            return function (ch, auto, mobileClick, follow) {
                ...
                if ($.mobile) {
                    ...
                    fChat.style.height = mobileClick ? '100%' : '45px';
        ...
        minForce: function () {
            ...
            if (!$.mobile) {
                ...
                fChat.style.height = browser.iPhone && m.minimize && 'auto' || (m.minimize ? '100%' : '45px');
    ...
    var parseEnv = function (o) {
        ...
        } else if (!E.secure && ev.mon.indexOf("https://") == 0) {
