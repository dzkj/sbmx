	...
	<section class="pop_bg">
     ...
     <section>
      ...
      <a href="banner5.php" style="margin-top:5px;margin-left:10px;" class="fr top_rt_btn">图片五</a>
       <a href="banner4.php" style="background: #19a97b;color: #f8f8f8;margin-top:5px;margin-left:10px;" class="fr top_rt_btn">图片四</a>
      ...
      <section>
		<?php
		$sqlbanner="select * from banners where id=4";
		...
		<form name="write_content" action="banner_do.php" method="post" enctype="multipart/form-data">
			...
			<h2><strong style="color:grey;">图片四</strong></h2>
			<li>
