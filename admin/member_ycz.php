      ...
      <div class="pop_cont">
       ...
       <div class="btm_btn">
		...
		if (isset($_GET['page']))   
			...
			$page=1;
		$gres=mysql_query("select count(*) from memcredits where actionname='充值' and status!=0"); //获得记录总数
		...
		$result=mysql_query("select a.status,a.bydate,a.backinfo,a.credits as acredits,b.* from memcredits as a,member as b where a.mid=b.id and a.status!=0 and a.actionname='充值' order by bydate desc limit $startCount,$perNumber"); //根据前面的计算出开始的记录和记录数
     ...
     <section>
      ...
      <table class="table">
       ...
       <tr>
        ...
        <td style="width:600px;"><div style="width:600px;" class="cut_title ellipsis"><?php echo $prow['backinfo']?></div></td>
