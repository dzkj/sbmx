	...
	<section class="pop_bg">
     ...
     <section>
      <div class="page_title">
       <h2 class="fl">横幅修改</h2>
       <a href="banner5.php" style="margin-top:5px;margin-left:10px;" class="fr top_rt_btn">图片五</a>
       ...
       <a href="banner2.php" style="background: #19a97b;color: #f8f8f8;margin-top:5px;margin-left:10px;" class="fr top_rt_btn">图片二</a>
       <a href="banner.php" style="margin-top:5px;margin-left:10px;" class="fr top_rt_btn">图片一</a>
      </div>
      <section>
		<?php
		$sqlbanner="select * from banners where id=2";
		...
		<form name="write_content" action="banner_do.php" method="post" enctype="multipart/form-data">
			...
			<h2><strong style="color:grey;">图片二</strong></h2>
			<li>
