	...
	<section class="pop_bg">
     ...
     <section>
      <div class="page_title">
       ...
       <a href="banner.php" style="background: #19a97b;color: #f8f8f8;margin-top:5px;margin-left:10px;" class="fr top_rt_btn">图片一</a>
      </div>
      <section>
		<?php
		$sqlbanner="select * from banners where id=1";
		...
		<form name="write_content" action="banner_do.php" method="post" enctype="multipart/form-data">
			...
			<h2><strong style="color:grey;">图片一</strong></h2>
			<li>
