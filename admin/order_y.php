 ...
 <div class="rt_content">
     ...
     <section>
      <div class="page_title">
       <h2 class="fl">已处理订单</h2>
		<a href="order_y.php" style="margin-top:5px;margin-left:10px;background:#19a97b;color:#fff;" class="fr top_rt_btn">已处理</a>
		<a href="order.php" style="margin-top:5px;" class="fr top_rt_btn">待处理</a>
      </div>
      <table class="table">
       <tr>
        <th>订单号</th>
		...
		?>
		   <tr>
			...
			<td style="min-width:180px;width:200px;">
			 <a id="<?php echo $yangzi;?>"><?php echo $zhuangtai?></a>
			</td>
		   </tr>
		<?php 
		}
