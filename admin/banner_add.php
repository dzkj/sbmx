      ...
      <div class="page_title">
       ...
       <a style="margin-top:5px;" href="index.php" class="fr top_rt_btn">返回</a>
		 ...
		 <section>
		  ...
		  <form name="write_content" action="banner_action.php" method="post" enctype="multipart/form-data">
			  <ul class="ulColumn2">
				...
				?>
					<option value="<?php echo $row['id'];?>"><?php echo $row['show_title'];?></option>
				<?php
					}
				?>
				</select>
