        ...
        <div class="main">
            <div>
                <ul class="orders-tab clearfix" style=" margin-bottom:10px;">
                    ...
                    <li class="orders-tab-actived" id="paid-li"><a href="orders_over.php">已付款</a></li>
            ...
            <div class="orders" id="orders-tbpay">
                ...
                <?php
                $ordersql = "select * from orders where order_status='已付款' group by order_id order by order_time desc";
                $orderres = mysql_query($ordersql);
                while($orderrow = mysql_fetch_array($orderres)){
                ?>
                <div class="one-order">
                    <div class="order-item-section">
                        <h3>订单号：<?php echo $orderrow['order_id'];?><span class="fr not-used">已付款</span></h3>
