...
if (isset($_GET['addr_id'])) {
    ...
    $addrsql = "select * from address where id='$addr_id'";
    $addrres = mysql_query($addrsql);
    $addrrow = mysql_fetch_array($addrres);
} else {
        ...
        <div id="main">
            <form id="form1" action="editaddr_do.php" method="post">
                ...
                <div class="input-item clearfix">
                    ...
                    <input type="text" style="padding-left:50px" value="<?php echo $addrrow['true_phone']; ?>" name="true_phone" id="phone">
                </div>
                <div class="input-item clearfix">
